...
| [3D Agent Monitor Dashboard](usecases/3d-agent-monitor.md) | Real-time 3D visualization of OpenClaw agents and sessions in a Three.js world with physics, pathfinding, and live chat. |
